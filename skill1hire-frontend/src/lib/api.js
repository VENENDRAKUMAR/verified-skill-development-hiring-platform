...
export const candidateAPI = {
  ...
  getMySessions: (p) => api.get("/candidate/sessions", { params: p }),
  getAllCandidates: (p) => api.get("/candidate", { params: p }),
};
...
export const adminAPI = {
  ...
  getUserAssessmentResults: (id) => api.get(`/admin/users/${id}/assessment-results`),
  verifyUser: (id, d) => api.put(`/admin/verify/${id}`, d),
  getPendingVerifications: (role) => api.get(`/admin/pending/${role}`),
  toggleUserActive: (id) => api.put(`/admin/users/${id}/toggle-active`),
  updateCapstoneStatus: (id, d) => api.put(`/admin/users/${id}/capstone-status`, d),
  ...
  getCapstones: () => api.get("/admin/capstones"),
...
export const messageAPI = {
  ...
  sendMessage: (chatId, text, fileUrl) => api.post("/message", { chatId, text, fileUrl }),
